...
├── assets/
│   ├── projects/
│   │   └── [removed].webp              NEW (converted from [removed] PNG)
      ...
      <section id="about" class="section">
        <div class="container">
          ...
          <div class="about">
            ...
            <p>What I&rsquo;m best at: turning a messy real-world domain ([removed-domain], sports-book pricing, broker order flow) into clean abstractions and a service that doesn&rsquo;t wake me up at 3am.</p>
          ...
          <div class="projects">
            ...
            <article class="project">
              <header class="project__head">
                <span class="status status--active" aria-label="Status: active"></span>
                <span class="project__status-label">ACTIVE</span>
                <span class="project__last-commit" data-meta="[removed].last_commit">last commit: recent</span>
              </header>
...
## Task 8: Project cards — [removed] screenshot + output samples

Convert the [removed] overview screenshot to WebP and add it to the [removed] card. Add small "output sample" code blocks to the cards without
images.

**Files:**
- Create: `C:/Users/14jak/GitHub/website/assets/projects/[removed].webp`
- Modify: `C:/Users/14jak/GitHub/website/index.html` (project cards)
- Modify: `C:/Users/14jak/GitHub/website/styles.css` (append)

- [ ] **Step 1: Convert the [removed] screenshot to WebP**

```bash
mkdir -p "C:/Users/14jak/GitHub/website/assets/projects"
# Pillow ships with the Python on this machine; use it to encode WebP.
python -c "from PIL import Image; im = Image.open(r'C:/Users/14jak/GitHub/[removed]/worksheet-overview.png'); im.save(r'C:/Users/14jak/GitHub/website/assets/projects/[removed].webp', 'WEBP', quality=80, method=6)"
ls -la "C:/Users/14jak/GitHub/website/assets/projects/[removed].webp"
```
...
reference the PNG directly (copy `worksheet-overview.png` → `[removed].png`
and use `<img src="assets/projects/[removed].png">` instead of WebP).

- [ ] **Step 2: Add the [removed] image to its card**

In `index.html`, find the [removed] `<article>` block. After the
`<p class="project__chips">…</p>` line and before `</article>`, insert:

```html
              <figure class="project__media">
                <img src="assets/projects/[removed].webp" alt="[removed] worksheet overview" loading="lazy" decoding="async" width="1200" height="700" />
              </figure>
```
...
Reload. Each project card now has either a screenshot ([removed]) or a
...
```bash
git -C "C:/Users/14jak/GitHub/website" add assets/projects/[removed].webp index.html styles.css
git -C "C:/Users/14jak/GitHub/website" commit -m "feat(v2): add [removed] screenshot and per-project output samples"
```
...
`[removed].last_commit`, `last_deployed`.
...
`arbitrage`), one `[skip]` line for [removed] if the script doesn't have
access to the [removed-org]-Services org (which is fine — [removed]'s
...
- Project cards show status dots, last-commit text (real or default),
  and either a screenshot ([removed]) or an output sample.

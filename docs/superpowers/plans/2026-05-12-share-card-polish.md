...
for path in "" styles.css script.js favicon.svg favicon.ico apple-touch-icon.png assets/og-image.png assets/projects/mega-ttt.webp assets/projects/walking-jumping-cm.png assets/projects/fuse-web.webp resume.pdf; do
